...
trait AmazonQLDBProfile extends Profile with AmazonQLDBActionProvider {
...
/** The repository for persistence with using the Slick library.
  */
trait AmazonQLDBRepository[K <: @@[_, _], M <: EntityModel[K]] extends Repository[K, M] with AmazonQLDBProfile {
