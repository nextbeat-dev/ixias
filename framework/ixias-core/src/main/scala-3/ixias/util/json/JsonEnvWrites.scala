...
trait JsonEnvWrites extends EnvWrites {
  ...
  /** Serializer for ixias.util.EnumStatus
    */
  implicit def enumStatus[E <: ixias.util.EnumStatus]: Writes[E] = (o: E) => JsNumber(BigDecimal(o.code))

  /** Serializer for Seq[ixias.util.EnumBitFlags]
    */
  implicit def enumBitFlags[E <: ixias.util.EnumBitFlags]: Writes[E] = (o: E) => JsNumber(BigDecimal(o.code))
