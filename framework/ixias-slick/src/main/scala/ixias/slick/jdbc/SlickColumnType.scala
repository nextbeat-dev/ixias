...
trait SlickColumnType {
  ...
  val Utf8BinChar8    = SqlType("VARCHAR(8)   CHARACTER SET utf8mb4 COLLATE utf8mb4_bin")
  val Utf8BinChar16   = SqlType("VARCHAR(16)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin")
  val Utf8BinChar32   = SqlType("VARCHAR(32)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin")
  val Utf8BinChar64   = SqlType("VARCHAR(64)  CHARACTER SET utf8mb4 COLLATE utf8mb4_bin")
  val Utf8BinChar128  = SqlType("VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin")
  val Utf8BinChar255  = SqlType("VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin")
  ...
  val Text            = SqlType("TEXT CHARACTER SET utf8mb4")
